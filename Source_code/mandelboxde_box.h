...
// kt
// - renamed mandelboxde.cc to mandelboxde_ori.cc (this file) to preserve original,
// - this is the BOX code

double MandelBoxDE(const vec3 &p0, float rMin, float rFixed, float scale, int num_iter, float escape_time, double c1, double c2)
{
  vec3 p = p0;
